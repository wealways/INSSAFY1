  ...
  <div id="wrap">
    <div id="nav-container-pc" class="navigation">
      ...
      <div id="nav-btn-container">
        <button class="icon-btn" @click="clickNBtn1" v-if="getToken != ''">
        ...
        <button class="icon-btn" @click="clickNBtn2" style="padding-top:2px" v-if="getToken != ''">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
        ...
        <button id="login-btn" class="icon-btn b-title" @click="clickLoginBtn" v-if="getToken == ''">
          Login
        </button>
      </div>
    </div>
